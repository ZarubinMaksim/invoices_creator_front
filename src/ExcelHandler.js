  ...
  return (
    <div className="mt-4">
      ...
      <div className="flex gap-3 items-center mb-3">
        <button onClick={downloadSelected} className="bg-blue-500 text-white px-4 py-2 rounded ml-2">
          Download selected        
        </button>

        <button onClick={sendSelectedEmails} className="bg-green-500 text-white px-4 py-2 rounded ml-2">
          Email selected
        </button>
      </div>
